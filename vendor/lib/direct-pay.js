...
function DirectPay(setup){
    if (!(setup && setup.config)) throw new Error('Must be initialized with instance of intram.Setup');
        ...
        request.post(self.baseURL + '/credit-account')
            ...
            .end(function (err, res) {
                ...
                if (res.body.response_code === '00') {
                    ...
                    var e = new Error(util.format('Failed to credit account. '
